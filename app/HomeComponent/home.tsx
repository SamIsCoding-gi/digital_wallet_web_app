...
export default function HomeComponent() {
  ...
  return (
    <>
      <div className=" flex items-center justify-items-center flex-col font-[family-name:var(--font-geist-sans)]  ">
        <div
          className=" mb-[50px] flex flex-col items-center justify-items-center "
          id="home"
        >
          {errorLoadingWalletData ? (
            <div className="flex flex-col  mx-[10px] mt-[250px]">
              <div className=" flex flex-col items-center justify-items-center ">
                <span className="text-red-500 text-[15px] sm:text-[20px] md:text-[25px] lg:text-[30px] font-bold">
